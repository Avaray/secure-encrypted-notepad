...
- [x] **Remove "Hide panel headers"**: Remove the "Hide panel headers" option and all related logic/UI from the side panels.
...
- [x] **File Tree Auto-Resizing Bug**: Fix the issue where the file tree panel automatically expands horizontally when opening a directory containing long file or folder names.
