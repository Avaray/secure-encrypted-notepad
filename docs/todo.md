...
- [x] **Color Picker Interaction Bug**: Fix a critical issue in the Theme Editor where the color picker popup's internal sliders and selection fields (hue/shade/saturation) become unresponsive or 'stuck' during use, making it impossible to adjust colors correctly.
