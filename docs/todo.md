...
- [ ] **Customizable Comment Characters**: Allow users to define their own comment prefix (currently fixed to `//`). This will enable support for different syntax styles (e.g., `#`, `--`, `/*`) based on user preference.
