...
- [ ] **Optimize Compile Times for I18n**: The translation files (`.yml`) drastically increase build times (from a few seconds to tens of seconds). Resolve this by picking one of two solutions (the first is preferred):
