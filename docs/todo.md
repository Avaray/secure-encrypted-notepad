...
- [x] **About Panel Sponsor Buttons Layout**: Improve the layout of sponsor buttons in the "About" panel. Ensure that when the buttons wrap to a new line, they remain horizontally centered.
