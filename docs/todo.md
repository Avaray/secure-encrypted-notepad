...
- [ ] **Window Title Privacy**: Remove the `.sen` extension from the application window title and add an option to completely hide the currently edited filename to enhance privacy.
