...
- [x] **Debug Log & Status Messages Cleanup**: Review and clean up messages in the debug log and status bar. Some should be changed or removed, especially when directory and keyfile path protection is enabled.
- [x] **Missing Tests Analysis**: Check which unit tests or edge-cases are missing and implement them.
